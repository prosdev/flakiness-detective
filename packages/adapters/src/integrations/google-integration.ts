...
} from "../firestore/firestore-adapter";
import {
  GoogleGenAIConfig,
  createGoogleGenAIProvider,
  GOOGLE_GENAI_DEFAULTS,
} from "../embedding/google-genai-provider";
import {
  PlaywrightAdapter,
  PlaywrightAdapterConfig,
} from "../playwright/playwright-adapter";
import {
  createPlaywrightEmbeddingProvider,
  PLAYWRIGHT_EMBEDDING_DEFAULTS,
} from "../playwright/playwright-embedding";
import { PlaywrightFlakinessDetective } from "../playwright/playwright-detective";
...
export function createGoogleCloudDetective(config: GoogleCloudConfig) {
  ...
  return createFlakinessDetective(adapter, embeddingProvider, {
 ...
 */
export function createGooglePlaywrightDetective(
  config: GooglePlaywrightConfig
) {
  // Create the Firestore adapter
  ...
  class PlaywrightFirestoreAdapter extends PlaywrightAdapter {
    ...
    constructor(
      playwrightConfig: PlaywrightAdapterConfig,
